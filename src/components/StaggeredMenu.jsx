...
export const StaggeredMenu = ({
  position = 'right',
  colors = ['#142B52', '#254A7A', '#D4B06A', '#0A1026'],
  items = [],
  socialItems = [],
  displaySocials = true,
  ...
  className = '',
  logoUrl = '',
  menuButtonColor = '#D4B06A',
  openMenuButtonColor = '#F8F6EE',
  accentColor = '#D4B06A',
  ...
  const animateIcon = useCallback(opening => {
    ...
    if (opening) {
      ...
      spinTweenRef.current = gsap.to(icon, { rotate: 0, duration: 0.4, ease: 'power3.inOut', overwrite: 'auto' });
    }
  }, []);
  ...
  return (
    ...
    >
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors && colors.length ? colors : ['#142B52', '#254A7A', '#D4B06A', '#0A1026'];
